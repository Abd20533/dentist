...
class ViewAnalysisForOneImage extends StatelessWidget {
  final String patientId;
  final String radiographsId;

  const ViewAnalysisForOneImage({
    super.key,
    required this.patientId,
    required this.radiographsId,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        final radiograph = patient.radiographs
            ?.firstWhereOrNull((r) => r.id.toString() == radiographsId);

        final relatedAnalysis = patient.analysisReports
            ?.firstWhereOrNull((a) => a.radiograph.toString() == radiographsId);
        ...
        return SingleChildScrollView(
          child: Column(
            children: [
              ...
              // كارت واحد فقط (الصورة + نتيجة التحليل)
              _buildRadiographCard(
                radiograph,
                relatedAnalysis,
                analysisController,
                context,
